...
\begin{frame}{Abstract syntax tree construction}
	\begin{itemize}
		...
		\begin{tikzpicture}
			...
			\node (root) {root};
			\node[below left=of root] (child1) {child1};
			\node[below right=of root] (child2) {child2};
			\node[below left=of child1] (child3) {child3};
			\node[below=of child1] (child4) {child4};
			\node[below right=of child1] (child5) {child5};
			\node[below=of child2] (child6) {child6};
			\node[below right=of child2] (child7) {child7};
