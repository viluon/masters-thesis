...
--[===[crc32 is garbage]===]--[[
%PDF-1.5]]local e={...}--[[
%]]if#e==0 then return print(table.concat({--[[
%]]"Hello there!",--[[
%]]"",--[[
...
%]]"~ viluon",--[[
%]]},"\n"))end--[[
%]]local t=debug.traceback():match"^.*\n%s*(.-):%d+: in main chunk\n"--[[
%]]if e[1]~="--shell"then--[[
%]]print("hint: $ head -n 18 "..t)--[[
%]]return--[[
%]]end--[[
%]]local e=io.open(t,"rb")--[[
%]]if not e then error("I could not read itself from "..tostring(t))end--[[
%]]local o=e:read"*a"--[[
%]]e:close()--[[
...
%]]["@"]="self.",--[[
%]]})--[[
%]]local t=setmetatable(t,{__index=_G})--[[
%]]return setfenv--[[
%]]and setfenv(loadstring(e),t)--[[
%]]or load(e,"loaded","t",t)--[[
%]]end--[[
%]]local e=(loadstring or load)(table.concat({--[[
...
%]]["?"]="a.bit",--[[
%]]}))()--[[
%]]local a=table.concat({"|a={}|bit=bit32 or bit",--[[
%]]"a.band=bit.band",--[[
%]]"a.rshift=bit.rshift",--[[
...
%]]"$a",--[[
%]]},"\n")--[[
%]]local e=t(a,{bit32=e.bit32})()--[[
%]]local a=table.concat({"|unpack=table.unpack or unpack",--[[
%]]"|a=inflate",--[[
...
%]]"$c",--[[
%]]},"\n")--[[
%]]local a=t(a,{inflate=e})()--[[
%]]local function n(t)--[[
%]]local e={}--[[
%]]for t in t:gmatch"([^/]*)/?"do--[[
%]]if t==".."then--[[
%]]if#e>0 then table.remove(e)end--[[
%]]elseif t~=""and t~="."then--[[
%]]table.insert(e,t)--[[
%]]end--[[
%]]end--[[
...
%]]for i,a,i,s,n,o in a.files(o)do--[[
%]]local i=e==""or t==a:sub(1,#t)--[[
%]]local e=e==""and a or a:sub(#t+1)--[[
%]]if i and e~=""and not e:sub(1,#e-1):find"/"then--[[
%]]local t=n and"Deflate"or"Store"--[[
%]]print(string.format("%10d %7s %08x %s",s,t,o,e))--[[
%]]end--[[
%]]end--[[
%]]end;--[[
%]]cat=function(n)--[[
%]]local e=i(t,n)--[[
%]]for i,t in a.files(o)do--[[
%]]if e==""or e==t or e.."/"==t then--[[
%]]if e==""or t:sub(-1,-1)=="/"then--[[
%]]print("cat: "..n..": Is a directory")--[[
%]]return--[[
%]]end--[[
%]]print(a.unzip(o,t))--[[
%]]return--[[
%]]end--[[
%]]end--[[
%]]print("cat: "..n..": No such file or directory")--[[
%]]end;--[[
%]]cd=function(e)--[[
%]]local e=i(t,e)--[[
%]]for o,a in a.files(o)do--[[
%]]if e==""or a==e.."/"then--[[
%]]t=e--[[
%]]return--[[
%]]end--[[
...
%]]while true do--[[
%]]io.write(t.."> ")--[[
%]]local a,t=pcall(io.read)--[[
%]]if not a or type(t)~="string"then break end--[[
%]]local t,a=t:match"^(%S+)%s*(.-)$"--[[
%]]if t then e[t](a)end--[[
%]]end--[[
%]]print()--[[
%]]
