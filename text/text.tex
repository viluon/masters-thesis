...
\acrshort{p4} parser describes a finite state machine whose job is to recognize
valid packets and load their headers into the storage facilities of the target.
The machine begins executing from the \texttt{start} state.
...
Parser transitions\todo{semantically equivalent to \texttt{goto} statements}
...
% 1 new page of real text about p4: implement trace view for planet-garden
