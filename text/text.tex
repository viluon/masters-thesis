...
\newacronym{fpga}{FPGA}{field-pro\-grammable gate array}
...
\newcommand{\pdfacrlong}[1]{\texorpdfstring{\acrlong{#1}}{\glsentrylong{#1}}}
...
\include{text/chapters/results}
\include{text/chapters/conclusion}
