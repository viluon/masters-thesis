...
seem like a language server is merely a compiler frontend\todo{decide on \&
unify "frontend" vs "front-end" (back, mid, \dots)} with very little backend
...
The largest language servers conformant to \acrshort{lsp} offer a wide variety
