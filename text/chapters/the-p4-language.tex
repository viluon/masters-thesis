...
procedures, the top level constructs for executable code are mainly control
blocks, parsers, and actions. These will be explained in detail in this section.
...
parser ipv4_parser(packet_in packet, out IPv4 ipv4) { /* body omitted */ }
