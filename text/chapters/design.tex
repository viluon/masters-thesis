...
\todo[inline]{screw this, mention instead paths of FileIds and the thing with
spans in text vs spans in tokens}
...
by controlling memoization in a fine-grained manner using Salsa (storing
preprocessor state if need be).}
